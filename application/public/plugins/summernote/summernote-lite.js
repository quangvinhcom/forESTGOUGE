...
(function (global, factory) {
  ...
  var dropdown = renderer.create('<div class="note-dropdown-menu" role="list">', function ($node, options) {
      var markup = Array.isArray(options.items) ? options.items.map(function (item) {
          ...
          var $temp = $('<a class="note-dropdown-item" href="<?php echo base_url(); ?>#" data-value="' + value + '" role="listitem" aria-label="' + value + '"></a>');
  ...
  var dropdownCheck = renderer.create('<div class="note-dropdown-menu note-check" role="list">', function ($node, options) {
      var markup = Array.isArray(options.items) ? options.items.map(function (item) {
          var value = (typeof item === 'string') ? item : (item.value || '');
          var content = options.template ? options.template(item) : item;
          var $temp = $('<a class="note-dropdown-item" href="<?php echo base_url(); ?>#" data-value="' + value + '" role="listitem" aria-label="' + item + '"></a>');
  ...
  var videoDialog = function (opt) {
      var body = '<div class="note-form-group">' +
          ...
          '</div>';
      var footer = [
          '<button type="button" href="<?php echo base_url(); ?>#" class="note-btn note-btn-primary note-video-btn disabled" disabled>',
  ...
  var imageDialog = function (opt) {
      var body = '<div class="note-form-group note-group-select-from-files">' +
          ...
          '</div>';
      var footer = [
          '<button href="<?php echo base_url(); ?>#" type="button" class="note-btn note-btn-primary note-btn-large note-image-btn disabled" disabled>',
      ...
      var body = '<div class="note-form-group">' +
          ...
          (!opt.disableLinkTarget
              ? '<div class="checkbox">' +
                  ...
                  '</div>' : '');
      var footer = [
          '<button href="<?php echo base_url(); ?>#" type="button" class="note-btn note-btn-primary note-link-btn disabled" disabled>',
  ...
  */
  ...
  var HelpDialog = /** @class */ (function () {
      ...
      HelpDialog.prototype.initialize = function () {
          ...
          var body = [
              '<p class="text-center">',
              '<a href="<?php echo base_url(); ?>http://summernote.org/" target="_blank">Summernote 0.8.12</a> · ',
              '<a href="<?php echo base_url(); ?>https://github.com/summernote/summernote" target="_blank">Project</a> · ',
              '<a href="<?php echo base_url(); ?>https://github.com/summernote/summernote/issues" target="_blank">Issues</a>',
              '</p>',
          ].join('');
          this.$dialog = this.ui.dialog({
