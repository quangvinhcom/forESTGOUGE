...
<meta charset="utf-8" />
  ...
  <meta name="description" content="TLG,bizner,điểm 10,flexoffice,gocharm">
  <meta name="author" content="TLG,bizner,điểm 10,flexoffice,gocharm">
<link rel="shortcut icon" href="<?php echo base_url(); ?>public/images/favicon.ico" type="image/x-icon">
<link rel="icon" href="<?php echo base_url(); ?>public/images/favicon.ico" rel="stylesheet">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="<?php echo base_url(); ?>#"><i
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
           ...
           <!-- <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>./index2.html" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v2</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>https://adminlte.io/docs/3.0" class="nav-link">
